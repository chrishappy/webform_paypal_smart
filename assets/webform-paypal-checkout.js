  ...
  Drupal.behaviors.webformPaypalCheckout = {
    attach: function (context) {
      ...
      $('.js--webformPaypalCheckout', context).once('webformPaypalCheckout').each(function() {
        var $this = $(this),
            $submitButton = $this.find('.js--webformPaypalCheckoutSubmitButton');
        ...
        $this.after('<div id="checkout__paypal-buttons" />');
    ...
    initPaypalButtons: function (purchaseUnitsInfo) {
      var webformPaypalCheckout = this,
          paypalOrder = webformPaypalCheckout.createPaypalOrder(purchaseUnitsInfo);
    ...
    createPaypalOrder: function (purchaseUnitsInfo) {
      var paypalOrder = {
        locale: 'en_CA',
        country: 'CA',
        purchase_units: purchaseUnitsInfo,
        application_context: {
